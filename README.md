...
Открой телефон в той же сети или Chrome DevTools → device toolbar. Управление: оттяни нижнюю ручку и отпусти. Пунктир — предсказанная траектория. Цель — все золотые маяки, не больше шести бросков.
